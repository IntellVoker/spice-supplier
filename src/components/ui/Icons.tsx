...
export function MailIcon({ size = 26, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
...
export function MapPinIcon({ size = 26, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
...
export function StarIcon({ size = 28, ...props }: IconProps) {
  return (
    <svg {...base(size)} strokeWidth={1.8} {...props}>
      <path d="M12 2l2.4 7.4H22l-6 4.6 2.3 7.4L12 17l-6.3 4.4L8 14 2 9.4h7.6z" />
    </svg>
  );
}

export function WhatsAppIcon({ size = 26, ...props }: IconProps) {
  return (
